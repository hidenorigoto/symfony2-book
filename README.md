...
- p.46 demoアプリケーションのルートでは、パスの先頭に `/ja/` が入ります。また、ポート番号（8000）も追加してください。
...
- p.119 図4-14「プロファイラのメールパネルでメール本文を確認」内のお問い合わせ種別の表記が間違っていました。([差替画像](https://cloud.githubusercontent.com/assets/89830/12013282/b06a4348-ad56-11e5-9a02-9c0a3c0e292a.png))
